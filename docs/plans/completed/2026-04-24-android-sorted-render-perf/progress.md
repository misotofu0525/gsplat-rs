...
- Built and installed baseline APK on connected Android device `android-test-device`.
...
- Installed the APK on Android device `android-test-device`; existing `flowers_1.ply` remained in app storage.
