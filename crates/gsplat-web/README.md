...
- `createRenderer` accepts an optional storage-profile token (`full-f32` or
  `quantized`) so the resident GPU layout is packed at Surface create time.
  The default stays full-f32; this is not a published SDK option.
